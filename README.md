...
**Задание:** Написать набор функций на языке JavaScript,
...
**Цель:** изучение современного CSS и основ ООП на JavaScript.

**Задание:** модернизировать web-сайт из лабораторной работы №2
